...
def send_email():
    ...
    if textarea.get(1.0,END)=='\n':
       ...
       messageLabel.grid(row=1, column=0, padx=1, pady=3)
...
def total():
    ...
    frootiprice = int(frootiEntry.get()) * 100
    dewprice = int(dewEntry.get()) * 120
    pepsiprice = int(pepsiEntry.get()) * 50
    spriteprice = int(spriteEntry.get()) * 140
    cococolaprice = int(cococolaEntry.get()) * 80
...
customer_details_frame=LabelFrame(root,text='Customer Details',font=('times new roman',9,'bold')
                                  ,fg='gold',bd=8,relief=GROOVE,bg='gray20')
customer_details_frame.pack(fill=X)
nameLabel=Label(customer_details_frame,text='Name',font=('times new roman',10,'bold')
                ,bg='gray20',fg='white')
nameLabel.grid(row=0,column=0,padx=20,pady=2)
nameEntry=Entry(customer_details_frame,font=('times new roman',12),bd=7,width=18)
nameEntry.grid(row=0,column=1,padx=8)
phoneLabel=Label(customer_details_frame,text='Phone Number',font=('times new roman',10,'bold')
                ,bg='gray20',fg='white')
phoneLabel.grid(row=0,column=2,padx=20,pady=2)
phoneEntry=Entry(customer_details_frame,font=('times new roman',12),bd=7,width=18)
phoneEntry.grid(row=0,column=3,padx=8)
billnumberLabel=Label(customer_details_frame,text='Bill Number',font=('times new roman',10,'bold')
                ,bg='gray20',fg='white')
billnumberLabel.grid(row=0,column=4,padx=20,pady=2)
billnumberEntry=Entry(customer_details_frame,font=('times new roman',12),bd=7,width=18)
...
billmenuFrame=LabelFrame(root,text='Bill Menu',font=('times new roman',10,'bold'),
                          fg='gold',bd=1,relief=GROOVE,bg='gray20')
billmenuFrame.pack(fil=X)

cosmeticpriceLabel=Label(billmenuFrame,text='Cosmetic Price',font=('times new roman',12,'bold')
                ,bg='gray20',fg='white')
cosmeticpriceLabel.grid(row=0,column=0,sticky='w')
